...
const assetSchema = new mongoose.Schema(
  {
    ...
    // Processor
    cpuManufacturer: { type: String, trim: true },
    cpuModel: { type: String, trim: true },
...
assetSchema.pre("save", function () {
  ...
  this.summary = {
    ...
    manufacturer: this.manufacturer || this.cpuManufacturer || "N/A",
    model: this.model || this.cpuModel || "N/A",
  };
});
